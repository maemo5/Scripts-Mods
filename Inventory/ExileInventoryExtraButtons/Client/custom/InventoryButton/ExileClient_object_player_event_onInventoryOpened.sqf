...
try 
{
	...
	_button1 ctrlSetStructuredText parseText "<t size='1' align='center' font='RobotoCondensed'>HELLO</t>";
	_button1 ctrlAddEventHandler ["ButtonClick", "_this call InventoryButton"];
