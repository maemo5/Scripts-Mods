class ChaosPilot_Loiter_Dialog
{
	...
	class controlsBackground 
	{
		...
		class ChaosPilot_rsc_Background: RscPicture
		{
			idc = -1;
	...
	{
		//map
		class ChaosPilot_rsc_Map: RscMapControl
		{
			idc = 1800;
		...
		//TEXT START//
		class ChaosPilot_rsc_text_Radius: RscText
		{
			idc = -1;
		...
		class ChaosPilot_rsc_text_Height: RscText
		{
			idc = -1;
		...
		class ChaosPilot_rsc_text_Side: RscText
		{
			idc = -1;
		...
		//COMBO START//
		class ChaosPilot_rsc_combo_Radius: RscCombo
		{
			idc = 3100;
			x = 0.127372 * safezoneW + safezoneX;
		...
		class ChaosPilot_rsc_combo_Height: RscCombo
		{
			idc = 3101;
			x = 0.127372 * safezoneW + safezoneX;
		...
		class ChaosPilot_rsc_combo_Side: RscCombo
		{
			idc = 3102;
			x = 0.127372 * safezoneW + safezoneX;
		...
		class ChaosPilot_rsc_btn_TurnOn: RscButton
		{
			idc = 3600;
