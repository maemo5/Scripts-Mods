...
class CfgA3XAISettings {
	...
	airVehicleList[] = {
		{"CUP_B_Merlin_HC3A_Armed_GB",1},
		{"Exile_Chopper_Huron_Black",1},
		{"Exile_Chopper_Hummingbird_Green",1}
	};
	...
	landVehicleList[] = {
		{"I_MRAP_03_hmg_F",1},
		{"CUP_B_HMMWV_M1114_USMC",1},
		{"CUP_B_MTVR_USMC",1},
		{"CUP_I_SUV_Armored_ION",1}
	};
