	...
	if (_playerUID in _buildRights) then
		{
			...
			if ((_flag getVariable ["ExileFlagStolen", 0]) isEqualTo 1) then 
				...
				else
				{
					...
					["InfoTitleAndText", ["Territory Information", format ["Payment Due for: <t color='#E48A36'>%2</t><br/>Date: <t color='#E48A36'>%1</t><br/>Pay Protection at your Flag!",_dueDate,_territoryName]]] call ExileClient_gui_toaster_addTemplateToast;
				};
