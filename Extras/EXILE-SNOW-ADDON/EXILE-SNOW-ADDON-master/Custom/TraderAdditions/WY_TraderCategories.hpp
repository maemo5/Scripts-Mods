	...
	class WYUniforms
	{
		...
		items[] = 
		{
			...
			"WY_Snow_O_clothing_a",
			"WY_Snow_O_clothing_b",
			"WY_Snow_O_clothing_c",
			"WY_Snow_HeliPilotCoverall_a",
			"WY_Snow_HeliPilotCoverall_b",
			"WY_Snow_HeliPilotCoverall_c"
		};
	};
