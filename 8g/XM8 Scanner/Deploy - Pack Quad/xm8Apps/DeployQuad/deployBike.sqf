...
if ("Exile_Item_DuctTape" in (magazines player)) then {	
    ...
    ["SuccessTitleAndText", ["Quad deployed!", "Your Duct Tape have been removed."]] call ExileClient_gui_toaster_addTemplateToast;
}
else
{
    ["ErrorTitleAndText", ["Can't deploy Quad", "You don't own a Duct Tape."]] call ExileClient_gui_toaster_addTemplateToast;
};
