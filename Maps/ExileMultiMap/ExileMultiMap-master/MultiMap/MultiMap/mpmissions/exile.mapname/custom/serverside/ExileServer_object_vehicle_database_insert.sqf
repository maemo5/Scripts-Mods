...
_vectorUp = vectorUp _vehicleObject;
	diag_log format["database_insert >>>> _vehicleObject = %1, _position = %2, _vectorDirection = %3, _vectorUp = %4",_vehicleObject, _position,_vectorDirection,_vectorUp];
_data =
[
...
_extDB2Message = ["insertVehicle", _data] call ExileServer_util_extDB2_createMessage;
 	diag_log format["_extDB2Message = %1",_extDB2Message];
...
_vehicleObject setVariable["ExileIsPersistent", true];
 	diag_log format["_vehicleID = %1",_vehicleID];
_vehicleID