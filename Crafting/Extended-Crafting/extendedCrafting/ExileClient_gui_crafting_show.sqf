...
private["_recipeClassName", "_recipeConfig", "_recipeName", "_pictureItemClassName", "_pictureItemConfig",
 ...
 "_pictureItemConfigWeapons","_wScomponentItemName","_wScomponentWeapName","_weld","_gen","_toolTrolley"];
...
{
	_description = _description + format["<t size='1' font='puristaMedium' align='left'>%1</t>", "EBM Welder"];
...
{
	_description = _description + format["<t size='1' font='puristaMedium' align='left'>%1</t>", "EBM Generator"];
...
{
	_description = _description + format["<t size='1' font='puristaMedium' align='left'>%1</t>", "EBM Tool Trolley"];
